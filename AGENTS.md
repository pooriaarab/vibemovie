...
```text
branch:  vm-<issue>-<slug>          vm-142-fix-onboarding-drop-off
title:   [VM-<issue>] <Subject>   [VM-142] Fix onboarding drop-off
body:    Closes #142
...
Read `.agents/design.md` before changing visual or interaction surfaces.
